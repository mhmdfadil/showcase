...
<div class="container-fluid">
            ...
            <div class="card shadow-sm border-0 hover-scale">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="text-muted mb-1">Total Karya Anda</h6>
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <span class="badge bg-light-info text-info">
                            Top: {{ $categories->first()->nama_kategori ?? '-' }} (Anda)
                        </span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm border-0 hover-scale">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="text-muted mb-1">Rating Rata-rata Anda</h6>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                    <h6 class="m-0 font-weight-bold text-primary">Statistik Karya Anda</h6>
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header bg-white border-0">
                    <h6 class="m-0 font-weight-bold text-primary">Karya Terbaru Anda</h6>
                </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header bg-white border-0">
                    <h6 class="m-0 font-weight-bold text-primary">Kategori Populer Anda</h6>
                </div>
                <div class="card-body">
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-header bg-white border-0">
                    <h6 class="m-0 font-weight-bold text-primary">Komentar Terbaru Anda</h6>
                </div>
                <div class="card-body">
                    <div class="list-group list-group-flush">
