...
<div class="container-fluid px-4 py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ url()->previous() }}" class="btn btn-secondary rounded-pill px-4 shadow-sm">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <a href="{{ route('mahasiswa.akarya.byKategori', $kategori) }}" 
                           class="btn btn-sm btn-{{ !request()->has('year') && !request()->has('jenis_karya') ? 'primary' : 'light' }} rounded-pill px-3 shadow-sm">
                            <i class="bi bi-collection me-2"></i>Semua
                        </a>
                        @foreach($years as $year)
                        <a href="{{ route('mahasiswa.akarya.byKategoriAndYear', [$kategori, $year]) }}" 
                           class="btn btn-sm btn-{{ request()->is("*year=$year*") ? 'primary' : 'light' }} rounded-pill px-3 shadow-sm">
            ...
            <div class="card shadow-sm" style="border-radius: 12px; border: none;">
                <div class="card-body p-3">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <a href="{{ route('mahasiswa.akarya.byKategori', [$kategori, 'jenis_karya' => 'video']) }}" 
                        ...
                        <a href="{{ route('mahasiswa.akarya.byKategori', [$kategori, 'jenis_karya' => 'gambar']) }}" 
                        ...
                        <a href="{{ route('mahasiswa.akarya.byKategori', [$kategori, 'jenis_karya' => 'dokumen']) }}" 
