        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent p-0">
                    ...
                    <li class="breadcrumb-item"><a href="">Karya</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Detail</li>
                </ol>
            </nav>
        </div>
        <a href="{{ route('mahasiswa.akarya.publish') }}" class="btn btn-gradient-secondary rounded-pill px-4 py-2">
                        ...
                        <div class="modal fade" id="ratingModal" tabindex="-1" aria-labelledby="ratingModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('mahasiswa.akarya.rate', $karya) }}" method="POST">
                                        @csrf
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="comment-form-container">
                                <div class="default-comment-form" id="defaultCommentForm">
                                    ...
                                    <form action="{{ route('mahasiswa.akarya.comment', $karya) }}" method="POST">
                                        @csrf
            ...
            <div class="card shadow-sm h-100 border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex align-items-center mb-4 pb-3 border-bottom">
                        ...
                        <div>
                            <h6 class="mb-1">
                                <a href="{{ route('mahasiswa.akarya.show', $related) }}" class="text-decoration-none text-dark">
