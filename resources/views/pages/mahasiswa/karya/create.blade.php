        ...
        <div class="col-md-12">
            <div class="card shadow-sm" style="border-radius: 12px; border: none;">
                ...
                <div class="card-body p-4">
                    <form id="uploadForm" method="POST" action="{{ route('mahasiswa.karya.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="hidden" class="form-control" value="{{ $user->id }}" id="user_id" name="user_id" required>
                                    <input type="text" class="form-control " style="background: rgb(167, 166, 166); color:#fff;" value="{{ $user->name }}" id="name" name="name" readonly required>
                                </div>
                            </div>
                        </div>
