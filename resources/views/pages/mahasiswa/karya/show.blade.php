        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent p-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('mahasiswa.mahasiswa.karya.index') }}">Karya</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Detail</li>
                </ol>
            </nav>
        </div>
        <a href="{{ route('mahasiswa.mahasiswa.karya.index') }}" class="btn btn-gradient-secondary rounded-pill px-4 py-2">
