...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h3 class="m-0 mt-2 mb-2 font-weight-bold text-primary">Validasi Karya</h3>
        </div>
    </div>
    ...
    <div class="card shadow-sm mb-4" style="border-radius: 12px; border: none;">
        <div class="card-body p-3">
            <div class="btn-group shadow-sm" role="group">
                <a href="{{ route('admin.admin.karya.index', ['tab' => 'all']) }}" 
                   class="btn btn-{{ request('tab', 'all') === 'all' ? 'primary' : 'light' }} px-4 py-2">
                    Semua
                </a>
                <a href="{{ route('admin.admin.karya.index', ['tab' => 'menunggu']) }}" 
                   class="btn btn-{{ request('tab') === 'menunggu' ? 'primary' : 'light' }} px-4 py-2">
                    Menunggu
                </a>
                <a href="{{ route('admin.admin.karya.index', ['tab' => 'diterima']) }}" 
                   class="btn btn-{{ request('tab') === 'diterima' ? 'primary' : 'light' }} px-4 py-2">
                    Diterima
                </a>
                <a href="{{ route('admin.admin.karya.index', ['tab' => 'ditolak']) }}" 
                   class="btn btn-{{ request('tab') === 'ditolak' ? 'primary' : 'light' }} px-4 py-2">
                    Ditolak
                </a>
                <a href="{{ route('admin.admin.karya.index', ['tab' => 'perbaikan']) }}" 
                ...
                <div class="btn-group" role="group">
                    ...
                    <ul class="dropdown-menu" style="z-index:;">
                        <li>
                            <a class="dropdown-item {{ request('tab') === 'video' ? 'active' : '' }}" 
                               href="{{ route('admin.admin.karya.index', ['tab' => 'video']) }}">
                                Video
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item {{ request('tab') === 'dokumen' ? 'active' : '' }}" 
                               href="{{ route('admin.admin.karya.index', ['tab' => 'dokumen']) }}">
                                Dokumen
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item {{ request('tab') === 'gambar' ? 'active' : '' }}" 
                               href="{{ route('admin.admin.karya.index', ['tab' => 'gambar']) }}">
                                Gambar
                            </a>
                        </li>
                    </ul>
            ...
            <div class="card h-100 shadow-sm hover-lift" style="border-radius: 12px; border: none;">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.karya.show', $karya) }}" class="btn btn-sm btn-primary rounded-pill px-3">
