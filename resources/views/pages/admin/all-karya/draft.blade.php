...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 py-3">
        <div>
            <h3 class="m-0 font-weight-bold text-primary">Draft Karya</h3>
            <p class="m-0 text-muted">Karya yang akan dipublikasikan di masa depan</p>
        </div>
        <a href="{{ route('admin.akarya.index') }}" class="btn btn-outline-secondary rounded-pill px-4">
    ...
    <div class="row g-4">
        ...
        <div class="col-xl-3 col-lg-4 col-md-6">
            <div class="card card-hover h-100 border-0 shadow-sm">
                <a href="{{ route('admin.akarya.byKategori', $kategori) }}" class="text-decoration-none text-dark">
                    <div class="card-body p-4">
                        <div class="d-flex align-items-center">
                            <div class="icon-wrapper bg-light-primary rounded-circle p-3 me-3">
                                <i class="bi bi-folder-fill text-primary fs-2"></i>
                                <span class="position-absolute top-0 end-0 mt-4 translate-middle badge rounded-pill bg-warning">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <p class="card-text text-muted small mb-0">{{ $kategori->karyas_count }} draft karya</p>
                            </div>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body text-center py-5">
                    <i class="bi bi-file-earmark-lock display-4 text-muted mb-3"></i>
                    <h5 class="text-muted">Tidak ada draft karya</h5>
                    <p class="text-muted">Belum ada karya yang akan dipublikasikan</p>
