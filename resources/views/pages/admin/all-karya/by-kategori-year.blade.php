        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.akarya.byKategori', $kategori) }}">Kategori</a></li>
                    <li class="breadcrumb-item active" aria-current="page">{{ $tahun }}</li>
                </ol>
            </nav>
        </div>
        <a href="{{ route('admin.akarya.byKategori', $kategori) }}" class="btn btn-secondary rounded-pill px-4 shadow-sm">
            ...
            <div class="card shadow-sm mb-4" style="border-radius: 12px; border: none;">
                <div class="card-body p-3">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <a href="{{ route('admin.akarya.byKategori', $kategori) }}" 
                        ...
                        <a href="{{ route('admin.akarya.byKategoriAndYear', [$kategori, $year]) }}" 
        ...
        <div class="col-md-4">
            <div class="card shadow-sm" style="border-radius: 12px; border: none;">
                <div class="card-body p-3">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <a href="{{ route('admin.akarya.byKategoriAndYear', [$kategori, $tahun]) }}" 
                           class="btn btn-sm btn-{{ !request()->has('jenis_karya') ? 'primary' : 'light' }} rounded-pill px-3 shadow-sm">
                            <i class="bi bi-collection me-2"></i>Semua
                        </a>
                        <a href="{{ route('admin.akarya.byKategoriAndYear', [$kategori, $tahun, 'jenis_karya' => 'video']) }}" 
                        ...
                        <a href="{{ route('admin.akarya.byKategoriAndYear', [$kategori, $tahun, 'jenis_karya' => 'gambar']) }}" 
                        ...
                        <a href="{{ route('admin.akarya.byKategoriAndYear', [$kategori, $tahun, 'jenis_karya' => 'dokumen']) }}" 
            ...
            <div class="card h-100 shadow-sm hover-lift" style="border-radius: 12px; border: none;">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('admin.akarya.show', $karya) }}" class="btn btn-sm btn-primary rounded-pill px-3">
        ...
        <div class="col-12">
            <div class="card shadow-sm" style="border-radius: 12px; border: none;">
                <div class="card-body text-center py-5">
                    ...
                    <a href="{{ route('admin.akarya.byKategori', $kategori) }}" class="btn btn-primary rounded-pill px-4 mt-3">
