            ...
            <div class="card shadow-sm" style="border-radius: 12px; border: none;">
                <div class="card-body p-3">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        ...
                        <a href="{{ route('admin.akarya.byKategori', [$kategori, 'jenis_karya' => 'video']) }}" 
                        ...
                        <a href="{{ route('admin.akarya.byKategori', [$kategori, 'jenis_karya' => 'gambar']) }}" 
                        ...
                        <a href="{{ route('admin.akarya.byKategori', [$kategori, 'jenis_karya' => 'dokumen']) }}" 
