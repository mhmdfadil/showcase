...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h3 class="m-0 mt-2 mb-2 font-weight-bold text-primary">Manajemen Kategori & Tag</h3>
        </div>
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                     ...
                     <div>
                           @if($activeTab === 'kategori')
                              <a href="{{ route('admin.kategori.create') }}" class="btn btn-primary rounded-pill px-3 py-2" title="Tambah Kategori">
                                 <i class="bi bi-plus-lg"></i>
                              </a>
                           @else
                              <a href="{{ route('admin.tag.create') }}" class="btn btn-primary rounded-pill px-3 py-2" title="Tambah Tag">
                                 <i class="bi bi-plus-lg"></i>
                              </a>
                           @endif
                     </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                ...
                                                <form action="{{ route('admin.kategori.destroy', $kategori->id) }}" method="POST" class="delete-form">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                ...
                                                <form action="{{ route('admin.tag.destroy', $tag->id) }}" method="POST" class="delete-form">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" 
                                                            class="btn btn-sm btn-outline-danger rounded-circle p-2" 
