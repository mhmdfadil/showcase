...
class PublikKaryaMController extends Controller
{
    ...
    public function publish()
    {
        ...
        return view('pages.mahasiswa.all-karya.publish', ['kategoris' => $paginated]);
    }
    ...
    public function byKategori(Kategori $kategori, Request $request)
    {
        ...
        return view('pages.mahasiswa.all-karya.by-kategori', compact('kategori', 'years', 'karyas'));
    }
    ...
    public function byKategoriAndYear(Kategori $kategori, $tahun, Request $request)
    {
        ...
        return view('pages.mahasiswa.all-karya.by-kategori-year', compact('kategori', 'tahun', 'years', 'karyas'));
    }
    ...
    public function show(Karya $karya)
    {
        ...
        return view('pages.mahasiswa.all-karya.show', compact('karya', 'relatedKaryas', 'userRating'));
    }
